module Api
  module V1
    class EventsController < ApplicationController
      ...
      # GET /events/1/signup
      def signup
        # TODO: redirect to signup api call?
      end
      ...
      def signups
        ...
        render json: { adults: @signups_over_18.as_json, under_18: @signups_under_18.as_json }, status: :ok
      end
      ...
      def set_event
        @event = Event.where(soft_deleted: false).where(id: params[:id])
      end
